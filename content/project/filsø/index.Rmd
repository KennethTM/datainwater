...
We have described the mechanisms and cicumstances surrounding these events in a paper published in [Science of the Total Environment](https://www.sciencedirect.com/science/article/pii/S0048969720335920). Code used for the analysis and figures are available from my [Github repository](https://github.com/KennethTM/FilsoOxygenDepletion).
