...
## Sudden death of 80 tonnes fish  
...
In this project we investigate the causes of the fish kill. We examine the ability of many natural tracers to identify sources of easily degradable organic matter and water with high oxygen consumption. We have established stations where we measure water flow throughout the catchment and collect water samples several times a year. This way we can track and trace inputs of water solutes to the lake. 

### Fingerprinting water

We measure a large suite of natural tracers. For example, we measure dissolved organic matter flourescence. By exposing the water sample to light and measuring the response at many wavelengths we obtain a Excitation-Emission-Matrix (EEM). This shape of the resulting 3D surface depends on the different flourescent compounds and their abundance in the water sample. By collecting many EEM's, the flourescent compounds and their concentration can be determined using Parallel-Factor-Analysis (PARAFAC). 
