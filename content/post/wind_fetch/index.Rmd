...
The resulting rasters containing fetch length for each cell and direction are visualized below using Leaflet. Explore the interactive map and use the box to show/hide the raster layers, notice how islands create shelter and "reset" fetch. The sheltering affects the influence of wind and wave action.
...
In the future, I want to expand the functionality in WindFetch to enable simple wave modeling. Importing wind data and calculating metrics and weights should also be included. Finally, I hope to increase the speed of the algorithm and have some ideas on how to improve the current approach. Anyhow, this was a fun small project which improved my Python!